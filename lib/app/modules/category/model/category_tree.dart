...
List<CategoryTreeModel> categoryTreeModelFromJson(String str) => List<CategoryTreeModel>.from(json.decode(str).map((x) => CategoryTreeModel.fromJson(x)));

String categoryTreeModelToJson(List<CategoryTreeModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CategoryTreeModel {
    ...
    factory CategoryTreeModel.fromJson(Map<String, dynamic> json) => CategoryTreeModel(
        id: json["id"],
        name: json["name"],
        slug: json["slug"],
        ...
        path: json["path"],
        cover: json["cover"],
        children: json["children"] == null ? [] : List<CategoryTreeModel>.from(json["children"]!.map((x) => CategoryTreeModel.fromJson(x))),
...
final collectionNameValues = EnumValues({
    "product-category": CollectionName.PRODUCT_CATEGORY
});
