        ...
        () => Stack(
          ...
          children: [
            Scaffold(
              ...
              body: Obx(() {
                if (order.orderDetailsMap.isNotEmpty && authController.settingMap.isNotEmpty) {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                                      ...
                                      child: Center(
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            TextWidget(
                                              text: order.orderDetailsModel!.data!
                                                          .status ==
                                                      15
                                                  ? 'Order Canceled'.tr
                                                  : 'Order Rejected'.tr,
                              ...
                              order.orderDetailsModel!.data!.orderAddress!.isEmpty && order.orderDetailsModel!.data!.outletAddress != null? Container(
                                width: double.infinity,
                                decoration: BoxDecoration(
                                    color: AppColor.whiteColor,
                                    border: Border.all(
                                      ...
                                      Expanded(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            order.orderDetailsModel!.data!
                                                  .outletAddress!.phone.toString() == '' && order.orderDetailsModel!.data!
                                                  .outletAddress!.countryCode.toString() == '' ? SizedBox() :SizedBox(
                                              height: 12.h,
                                            ),
                                            order.orderDetailsModel!.data!
                                                  .outletAddress!.phone.toString() == '' && order.orderDetailsModel!.data!
                                                  .outletAddress!.countryCode.toString() == '' ? SizedBox() :TextWidget(
                                              text: 'Phone:'.tr,
                                              color: AppColor.textColor,
                                              fontSize: 12.sp,
                                              fontWeight: FontWeight.w600,
                                            ...
                                            order.orderDetailsModel!.data!
                                                  .outletAddress!.email.toString() == '' ? SizedBox() :SizedBox(
                                              height: 12.h,
                                            ),
                                            order.orderDetailsModel!.data!
                                                  .outletAddress!.email.toString() == '' ? SizedBox() :TextWidget(
                                              text: 'Email:'.tr,
                                              color: AppColor.textColor,
                                              fontSize: 12.sp,
                                              fontWeight: FontWeight.w600,
                                      ...
                                      Expanded(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            TextWidget(
                                              text: order.orderDetailsModel!.data!
                                                  .outletAddress!.address.toString(),
                              ...
                              : order.orderDetailsModel!.data!.orderAddress!.isNotEmpty?
                              Container(
                                width: double.infinity,
                                decoration: BoxDecoration(
                                    color: AppColor.whiteColor,
                                      ...
                                      Expanded(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            order.orderDetailsModel!.data!
                                                  .orderAddress![0].email.toString() == ''? SizedBox() :SizedBox(
                                              height: 12.h,
                                            ),
                                            order.orderDetailsModel!.data!
                                                  .orderAddress![0].email.toString() == ''? SizedBox() :TextWidget(
                                              text: 'Email:'.tr,
                                              color: AppColor.textColor,
                                              fontSize: 12.sp,
                                              fontWeight: FontWeight.w600,
                              ...
                              order.orderDetailsModel!.data!.orderAddress!.isEmpty? SizedBox() : SizedBox(
                                height: 16.h,
                              ),
                              order.orderDetailsModel!.data!.orderAddress!.isEmpty? SizedBox() : Container(
                                width: double.infinity,
                                decoration: BoxDecoration(
                                    color: AppColor.whiteColor,
                                    border: Border.all(
                                      ...
                                      Expanded(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            order.orderDetailsModel!.data!
                                                  .orderAddress![1].email.toString() == ''? SizedBox() :SizedBox(
                                              height: 12.h,
                                            ),
                                            order.orderDetailsModel!.data!
                                                  .orderAddress![1].email.toString() == ''? SizedBox() :TextWidget(
                                              text: 'Email:'.tr,
                                              color: AppColor.textColor,
                                              fontSize: 12.sp,
                                              fontWeight: FontWeight.w600,
                                        ...
                                        Padding(
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              return OrderWidget2(
                                                product: order.orderDetailsModel!
                                  ...
                                  InkWell(
                                    onTap: () {
                                      Get.to(() => PrintInvoice(
                                            ...
                                            address: order.orderDetailsModel!.data!.orderType.toString() == '10'? outletAddress : shippingAddress,
                                          ));
                                    },
                                    child: Container(
                                      height: 48.h,
