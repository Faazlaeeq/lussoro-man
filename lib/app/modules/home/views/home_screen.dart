            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                                                  ...
                                                  () => ProductWidget(
                                                    ...
                                                    discountPrice:
                                                        section[index]
                                                            .products![i]
                                                            .discountedPrice,
                                                    textRating: section[index]
                                                        .products![i]
                                                        .ratingStarCount,
                                                    flashSale: section[index]
                                                        .products![i]
                                                        .flashSale!,
                                                    isOffer: section[index]
                                                        .products![i]
                                                        .isOffer!,
                                                  ),
                                                ),
                  ...
                  Obx(() {
                    return popularProductController.popularModel.value.data !=
                            null
                        ? Padding(
                            padding: EdgeInsets.only(right: 16.w),
                            child: Row(
                                  ...
                                  children: [
                                    for (int index = 0;
                                      ...
                                      ProductWidget(
                                        ...
                                        productImage: popularProductController
                                            .popularModel
                                            .value
                                            .data?[index]
                                            .cover!,
                                        ...
                                        rating: popularProductController
                                            ...
                                            .ratingStar
                                            .toString(),
                                        currentPrice: popularProductController
                                            .popularModel
                                            .value
                                            .data?[index]
                                            .currencyPrice,
                                        discountPrice: popularProductController
                                            .popularModel
                                            .value
                                            .data?[index]
                                            .discountedPrice,
                  ...
                  Obx(() {
                    return flashSaleController.flashSaleModel.value.data != null
                        ? Padding(
                            padding: EdgeInsets.only(right: 16.w),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  ...
                                  () => StaggeredGrid.count(
                                    ...
                                    children: [
                                      for (int index = 0;
                                          ...
                                          index++)
                                        Obx(() {
                                          final flashSale = flashSaleController
                                              .flashSaleModel
                                              .value
                                              .data![index];
                  ...
                  SizedBox(height: 34.h),
                  Obx(() {
                    return brandController.brandModel.value.data != null
                                ...
                                return InkWell(
                                  ...
                                  onTap: () {
                                    filterController.addHomeBrandId(
                                        brandController
                                            .brandModel.value.data![index].id
                                            .toString());

                                    Get.to(() => CategoryWiseProductScreen(
                                          brandName: brandController.brandModel
