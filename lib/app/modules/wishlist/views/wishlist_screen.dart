                                          ...
                                          child: Obx(
                                            ()=> ProductWidget(
                                              favTap: () async {
                                                ...
                                                {
                                                  if(wishlistController.favoriteModel.value.data![i].wishlist == true)
                                                  {
                                                    await wishlistController
                                                    .toggleFavoriteFalse(wishlistController
                                                                .favoriteModel
                                                                .value
                                                                .data![i]
                                                                .id!);
                                            
                                                    wishlistController.showFavorite(wishlistController
                                                                .favoriteModel
                                                                .value
                                                                .data![i]
                                                                .id!);
                                                  ...
                                                  if(wishlistController.favoriteModel.value.data![i].wishlist == false)
                                                  {
                                                    await wishlistController
                                                    .toggleFavoriteTrue(wishlistController
                                                                .favoriteModel
                                                                .value
                                                                .data![i]
                                                                .id!);
                                              ...
                                              wishlist: wishlistController.favList.contains(wishlistController
                                                                .favoriteModel
                                                                .value
                                                                .data![i]
                                                  ...
                                                  .value
                                                  .data?[i]
                                                  .wishlist == true? true : false,
                                              productImage: wishlistController
                                                  .favoriteModel.value.data?[i].cover,
                                              title: wishlistController
                                                  .favoriteModel.value.data?[i].name,
                                              rating: wishlistController.favoriteModel
                                                  .value.data?[i].ratingStar,
