...
import 'package:single_ecommerce/payment/myfatoorah.dart';
...
class _PaymentState extends State<Payment> {
  ...
  Addwalletapi() async {
    ...
    if(transcationid != "" && transcationid != null) {
      loader.showLoading();
      try {
        var map = {
          "user_id": userid,
  ...
  mercadowalletapi() async {
    ...
    if(mercadotranscationid != "" && mercadotranscationid != null) {
      loader.showLoading();
      try {
        var map = {
          "user_id": userid,
                        ...
                        onTap: () {
                          ...
                          setState(() {
                            ...
                            environment = paymentlist!
                                .paymentmethods![index].environment.toString();
                            public_key =
