        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                currencyposition == "1"
                    ? "${'Refer_code1'.tr} $currency$_reffer_amount ${'Refer_code2'.tr}"
                    : "${'Refer_code1'.tr} $_reffer_amount$currency ${'Refer_code2'.tr}",
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 11.sp,
                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          Share.share(
                            currencyposition == "1"
                                ? '${'Use_this_code'.tr} $user_refer_code ${'to_register_with'.tr} ${'ecommerce_User'.tr} ${'get_bonus_amount'.tr} $currency$_reffer_amount \n $Androidapplink \n $Iosapplink   '
                                : '${'Use_this_code'.tr} $user_refer_code ${'to_register_with'.tr} ${'ecommerce_User'.tr} ${'get_bonus_amount'.tr} $_reffer_amount$currency \n $Androidapplink \n $Iosapplink  ',
                          );
                        },
                      ),
                    )
