...
import 'package:single_ecommerce/model/cart/toyyibpaymodel.dart';
...
import 'package:single_ecommerce/pages/cart/orderpayment/ordertoyyibpay.dart';
...
import '../../model/cart/mercadorequestmodel.dart';
...
class _PaymentoptionState extends State<Paymentoption> {
  ...
  toyyibpayAPI() async {
    ...
    try {
      ...
      if(paydata!.status == 1){
        ...
        Get.off(() => OrderToyyibpay())?.then((value) => toyyibpayapi());
      }
  ...
  toyyibpayapi() async {
    ...
    if(toyyibTransctionId != "" && toyyibTransctionId != null) {
      try {
        loader.showLoading();
        SharedPreferences prefs = await SharedPreferences.getInstance();
        userid = prefs.getString(UD_user_id);
  ...
  mercadoapi() async {
    ...
    if(mercadoTransctionId != "" && mercadoTransctionId != null) {
      try {
        loader.showLoading();
        SharedPreferences prefs = await SharedPreferences.getInstance();
        userid = prefs.getString(UD_user_id);
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          setState(() {
                            ...
                            numberpay =
                                paymentlist!.paymentmethods![index].id;
                          });
                        },
                        child: SizedBox(
                          height: 7.h,
